# Generated by Powerlevel10k configuration wizard on 2024-03-04 at 20:33 CET.
...
() {
  ...
  # Development container specific settings
typeset -g POWERLEVEL9K_DIR_CLASSES=(
    '~/work(|/*)' WORK ''
    '~/materials(|/*)' MATERIALS ''
    '*' DEFAULT ''
...
typeset -g POWERLEVEL9K_DIR_MATERIALS_FOREGROUND=254
typeset -g POWERLEVEL9K_DIR_MATERIALS_BACKGROUND=5
...
# Docker context
typeset -g POWERLEVEL9K_DOCKER_CONTEXT_SHOW_ON_COMMAND='docker|docker-compose|docker-machine|podman'
typeset -g POWERLEVEL9K_DOCKER_CONTEXT_CLASSES=('*' DEFAULT)
typeset -g POWERLEVEL9K_DOCKER_CONTEXT_DEFAULT_FOREGROUND=7
typeset -g POWERLEVEL9K_DOCKER_CONTEXT_DEFAULT_BACKGROUND=4
